...
type
  ...
  private
    function prepareInvoiceData : string;
...
//
{ Pøipraví veškerá data pro fakturu, vèetnì defaultního PDF adresáøe a jména souboru,
  pokud nejsou již nastavená
}

function TDesFastReport.prepareInvoiceData : string;
var
  slozenkaCastka,
  slozenkaVS,
  slozenkaSS,

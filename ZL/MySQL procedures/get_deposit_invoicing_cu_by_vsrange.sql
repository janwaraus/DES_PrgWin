...
DELIMITER //
CREATE PROCEDURE get_deposit_invoicing(
...
ORDER BY cu.variable_symbol, co.`number`, bi.tariff;
END //
DELIMITER ;


CALL get_deposit_invoicing('2023-05-01','2023-05-31')

drop procedure get_deposit_invoicing
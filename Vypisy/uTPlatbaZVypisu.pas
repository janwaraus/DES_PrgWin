...
begin
  ...
  if kredit AND (self.cisloUctu = '2921537004/5500') then setZnamyPripad('z RB BÚ');
  if kredit AND (self.cisloUctu = '2921537012/5500') then setZnamyPripad('z RB Sp.Ú');
  ...
  if debet AND (self.cisloUctu = '2921537004/5500') then setZnamyPripad('na RB BÚ');
  if debet AND (self.cisloUctu = '2921537012/5500') then setZnamyPripad('na RB Sp.Ú');
